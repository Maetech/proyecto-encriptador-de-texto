...
function btnEncriptar () {
    ...
    if(tex == ''){
        ...
        alerta.style.color = '#FFF'
        alerta.style.fontweight = '800'
        alerta.textContent = 'NOTA: Recuerda que no debe tener acentos y caracteres especiales'

    } else if(tex !== txt.toLowerCase()){
        alerta.style.background = '#0A3871'
        alerta.style.color = '#FFF'
        alerta.style.fontweight = '800'
        alerta.textContent = 'NOTA: Recuerda que todo el texto debe estar en minusculas'
    } else {
...
function btnCopiar () {
    ...
    alert('El contenido ha sido copiado a su portapaeles')
}